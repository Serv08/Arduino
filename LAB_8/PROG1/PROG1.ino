...
void setup() {
  ...
  lcd.createChar(1, peaceLeft);lcd.createChar(2, peaceMid);
  lcd.createChar(3, peaceRight);lcd.createChar(4, heartLeft);
  lcd.createChar(5, heartRight);lcd.createChar(6, codeLeft);
  lcd.createChar(7, codeRight);lcd.home();
  
  lcd.setCursor(1, 0);lcd.printByte(1);   
  lcd.printByte(2);lcd.printByte(3);

  lcd.setCursor(7, 0);lcd.printByte(4);  
  lcd.printByte(5);

  lcd.setCursor(12, 0);lcd.printByte(6);   
  lcd.printByte(7);

  lcd.setCursor(0, 1);lcd.print("Peace Love Code");
}
